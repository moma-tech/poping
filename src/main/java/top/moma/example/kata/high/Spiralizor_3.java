 ...
 * 0000000000
 *
 * <p>Return value should contain array of arrays, of 0 and 1, with the first row
 ...
 * [1,1,1,1,1]]
 *
 * <p>Because of the edge-cases for tiny spirals, the size will be at least 5.
 *
...
public class Spiralizor_3 {
  ...
  public static void main(String[] args) {
    ...
    int[][] r = Spiralizor_3.spiralize(size);
